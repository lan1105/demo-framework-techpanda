...
public class ExtentManager {
	...
	public synchronized static ExtentReports createExtentReports() {
		...
		reporter.config().setReportName("Tech Panda HTML Report");
		reporter.config().setDocumentTitle("Tech Panda HTML Report");
		...
		extentReports.setSystemInfo("Project", "Tech Panda");
